...
complete -c lls -n '__fish_use_subcommand' -a 'start stop status list info show-profile' -d 'llm subcommand'
complete -c lls -n '__fish_seen_subcommand_from start show-profile' -a '(__ll_models_for_host localhost)' -d 'GGUF model'
